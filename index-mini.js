...
let tempHtmlPath = path.resolve() + "/template/cl-mini.html"
let clHtmlPath = path.resolve() + "/dist/cl-mini.html"
...
async function testServe() {
  ...
  app.listen(8080, () => {
    ...
    console.log('cl accessable on http://localhost:8080/cl-mini.html');
  });
